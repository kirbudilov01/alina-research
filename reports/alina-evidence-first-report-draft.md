...
Generated: 2026-05-31T08:07:28.595Z
...
- Evidence audit register: 16 claim rows mapping hypotheses/requirements to proof status, confidence, gaps, and next actions.
- Evidence package manifest: 230 artifacts tracked, 59 CSV artifacts, 162143 tracked CSV rows, 0 missing required artifacts.
...
Manifest snapshot: 230 artifacts; 59 CSV artifacts; 162143 tracked CSV rows; 0 missing required artifacts.
...
| --- | --- | --- | --- | --- |
| REQ_01_MASTER_PLAN | proved_v1 | strong | master_plan=true; roadmap_rows=16; execution_dashboard_rows=11; hypothesis_decision_rows=6; p0_command_rows=75; p0_field_guide_sections=8; validation_workspace_lanes=5 | Keep refreshing as validation results change. |
...
Claim audit rows currently normalized: 16.
