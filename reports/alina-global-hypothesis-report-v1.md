...
Чтобы идея стала понятной для презентации, ее можно разложить на несколько продуктовых концепций. Во всех вариантах стартовый вход может быть очень простым: дата рождения, имя, время или место рождения, текущий запрос дня, настроение и короткий личный контекст. Важно, что дата рождения здесь не должна продаваться как жесткое предсказание. Она работает как символический и персональный вход: человек чувствует “это про меня”, но ценность появляется только тогда, когда этот вход превращается в действие, reset и видимый avatar/progress.

| Концепция | Что вводит человек | Что получает | Как соединяется с АУРОЙ | Почему это может работать |
| --- | --- | --- | --- | --- |
| 1. Daily Aura Code | Дата рождения + короткий вопрос “что сегодня хочется изменить?” | Персональный код дня: тема, риск дня, ресурс дня и одно маленькое действие. | Смысл дня превращается в действие; после выполнения avatar получает маленький визуальный слой. | Подходит как самый простой первый экран: быстро, лично, без тяжелого onboarding. |
| 2. Future Self Avatar | Дата рождения + цель пользователя: спокойствие, уверенность, фокус, отношения, тело, деньги. | Образ будущей версии себя и карта качеств, которые человек постепенно “прокачивает”. | Каждое действие усиливает конкретное качество avatar: ясность, смелость, мягкость, дисциплина. | Делает avatar центральной механикой, а не украшением профиля. |
| 3. Ritual of the Day | Дата рождения + состояние сейчас: тревожно, устало, расфокусировано, пусто, вдохновленно. | Короткий ежедневный ритуал: смысловая подсказка, 30-60 секунд reset и действие на сегодня. | Reset снижает сопротивление, действие завершает ритуал, прогресс фиксируется без наказания за пропуск. | Связывает spiritual/wellness вход с практической ежедневной привычкой. |
| 4. Symbol to Action | Дата рождения + выбранный символ дня: архетип, стихия, карта, цвет, энергия, настроение. | Символическая интерпретация без жестких обещаний и три варианта действия разной сложности. | Пользователь выбирает действие, делает его и видит, как символ дня становится частью avatar/progress. | Использует интерес к astrology/esoterics, но выводит его из чтения в поведение. |
| 5. Inner Weather | Дата рождения + быстрый чек-ин: энергия, напряжение, ясность, желание контакта. | “Внутренняя погода” дня: что поддерживает, что может мешать, какой шаг будет самым мягким. | Продукт не говорит “кто ты навсегда”, а помогает прожить один день осознаннее и увидеть сдвиг. | Снижает риск недоверия: это не диагноз и не судьба, а мягкая навигация по состоянию. |
| 6. Compatibility With Myself | Дата рождения + конфликт дня: хочу одно, делаю другое; хочу начать, но откладываю. | Разбор внутреннего конфликта: какая часть хочет роста, какая защищается, какой шаг их примиряет. | После действия avatar показывает не “уровень”, а согласованность: человек чуть ближе к себе. | Хорошо раскрывает эмоциональную глубину и может стать платной персональной механикой. |
| 7. Life Path Quests | Дата рождения + выбранное направление: отношения, карьера, тело, дом, творчество, уверенность. | Мягкая серия микро-квестов на неделю, где каждый день связан с одной темой и одним действием. | Неделя собирается в историю: avatar меняется не от streak, а от накопленных доказательств действий. | Дает возврат без давления: человек возвращается ради истории изменения, а не ради наказания. |
