...
Собрано: 2026-05-31T14:37:16.764Z
...
## 2. Сколько приложений и источников взяли по нишам

Ниже - самая важная таблица для ориентации. Raw rows показывают общий объем собранных строк из источников. Dedup rows - очищенную рабочую базу после снятия дублей. Это не значит, что каждая строка является прямым конкурентом Alina: часть gaming/Steam/itch строк используется как benchmark механик, а Reddit/forum строки используются как язык боли и контекст.

| Ниша | Raw rows | Dedup rows | OK rows | Как читать |
| --- | ---: | ---: | ---: | --- |
| Gaming / progression mechanics | 20,757 | 15,925 | 20,362 | benchmark механик, не прямой TAM |
| Astrology / esoterics | 5,427 | 2,657 | 5,396 | adjacent рынок для конкурентной карты |
| Avatar / identity | 14,872 | 9,952 | 14,181 | adjacent рынок для конкурентной карты |
| Coaching / self-improvement | 7,671 | 3,857 | 7,273 | adjacent рынок для конкурентной карты |
| Mindfulness / reset | 15,109 | 9,803 | 14,384 | adjacent рынок для конкурентной карты |
| Gaming progression sub-layer | 3,689 | 950 | 3,657 | benchmark механик, не прямой TAM |

Если смотреть только на более прямые source-native каналы приложений и витрин - App Store, Google Play/Android, desktop stores и browser extensions - там сейчас 30,176 raw rows и 11,334 dedup rows. Остальной объем дает более широкий discovery слой: Steam/itch для механик, Reddit/forum для языка аудитории и дополнительные source lanes для насыщения карты.
...
| Gaming / progression mechanics | 14,304 | 1.03% | механический benchmark, не основной whitespace | Не использовать как H3 proof. Это источник механик, а не доказательство рынка Alina. |
| Gaming progression sub-layer | 950 | 6.63% | механический benchmark, не основной whitespace | Не использовать как H3 proof. Это источник механик, а не доказательство рынка Alina. |
