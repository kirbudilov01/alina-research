...
- Charts are generated from normalized CSV files already committed in the repository.
- These are draft research visuals for fast inspection and later PDF/layout design.
