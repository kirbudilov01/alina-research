...
- Coverage cells: 34
- Strong coverage cells: 10
- Medium coverage cells: 12
- Thin but usable cells: 10
...
| steam_pc | gaming | 3256 | 96.7 | pc_progression_and_mechanic_benchmark | Use for market saturation, competitor discovery, and source-triangulation; sample manually before final claims. |
| steam_pc | mindfulness | 2911 | 98.7 | pc_progression_and_mechanic_benchmark | Use for market saturation, competitor discovery, and source-triangulation; sample manually before final claims. |
