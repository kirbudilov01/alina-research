...
const WORKSPACE = path.join(ROOT, 'tmp', 'presentations', THREAD_ID, 'aura-trendvi-style-deck-v7-main');
...
const PLAN_OUT = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v7-main.md');
const SOURCE_NOTES = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v7-main-sources.md');
const PPTX_OUT = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V7_MAIN.pptx');
const CONTACT_SHEET = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V7_MAIN_CONTACT_SHEET.png');
...
function writePlan() {
  const lines = ['# AURA Trendvi-Style Product Deck V7 Main', '', 'Deck mode: optimized client-facing AURA product deck. V7 Main is the client-facing story only: product, competitor meaning, money logic, GTM and launch decision. Detailed evidence stays in the full appendix version.', ''];
