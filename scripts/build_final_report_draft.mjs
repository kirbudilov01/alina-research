...
status.push(mdTable([
  ...
  { requirement: 'Russian narrative document', evidence: 'reports/alina-russian-narrative-report-v1.md; output/pdf/alina-russian-narrative-report-v1.pdf; data_processed/russian_narrative_evidence_map.csv; data_processed/russian_market_sizing_playbook.csv; data_processed/russian_market_deep_dives.csv; data_processed/russian_competitor_battlecards.csv; data_processed/russian_icp_battlecards.csv; data_processed/russian_product_loop_cards.csv; data_processed/russian_validation_gate_cards.csv; data_processed/russian_p0_execution_packet.csv; data_processed/russian_claim_evidence_appendix.csv; data_processed/russian_source_provenance_index.csv; docs/decision/russian-narrative-evidence-map-v1.md; docs/market/russian-market-sizing-playbook-v1.md; docs/market/russian-market-deep-dives-v1.md; docs/competitive/russian-competitor-battlecards-v1.md; docs/audience/russian-icp-battlecards-v1.md; docs/product/russian-product-loop-cards-v1.md; docs/decision/russian-validation-gate-cards-v1.md; docs/decision/russian-p0-execution-packet-v1.md; docs/decision/russian-claim-evidence-appendix-v1.md; docs/decision/russian-source-provenance-index-v1.md', status: 'done v1; sequential Russian-language narrative report, argument map, TAM/SAM/SOM playbook, five-market deep dives, competitor battlecards, ICP battlecards, product-loop cards, validation gate cards, P0 execution packet, claim evidence appendix, and source provenance index generated from evidence warehouse' },
