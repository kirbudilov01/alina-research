...
report.push(`- Russian narrative report: ${fs.existsSync('output/pdf/alina-russian-narrative-report-v1.pdf') ? 'generated as a sequential Russian-language narrative PDF' : 'not generated yet'}; argument map: ${fs.existsSync('data_processed/russian_narrative_evidence_map.csv') ? 'generated' : 'not generated yet'}; Russian market deep dives: ${russianMarketDeepDives.length} market rows; Russian fieldbook: ${fs.existsSync('data_processed/russian_validation_fieldbook.csv') ? 'generated' : 'not generated yet'}.`);
...
status.push(mdTable([
  ...
  { requirement: 'Russian narrative document', evidence: 'reports/alina-russian-narrative-report-v1.md; output/pdf/alina-russian-narrative-report-v1.pdf; data_processed/russian_narrative_evidence_map.csv; data_processed/russian_market_deep_dives.csv; docs/decision/russian-narrative-evidence-map-v1.md; docs/market/russian-market-deep-dives-v1.md', status: 'done v1; sequential Russian-language narrative report, argument map, and five-market deep dives generated from evidence warehouse' },
