...
const requirements = [
  ...
  },
  {
    ...
    status: polishedPdfExists && russianNarrativePdfExists ? 'polished_and_russian_narrative_drafts_done_not_validated_final' : (polishedPdfExists ? 'polished_evidence_draft_done_not_validated_final' : (fs.existsSync('output/pdf/alina-evidence-first-report-draft.pdf') ? 'draft_done_not_polished_final' : 'missing')),
    ...
    evidence_files: 'reports/alina-evidence-first-report-draft.md;reports/alina-russian-narrative-report-v1.md;output/pdf/alina-evidence-first-report-draft.pdf;output/pdf/alina-evidence-visual-report-v1.pdf;output/pdf/alina-polished-evidence-pack-v1.pdf;output/pdf/alina-russian-narrative-report-v1.pdf;docs/decision/polished-evidence-pack-v1.md',
    remaining_gap: 'Polished evidence PDF and Russian narrative PDF exist as publication-ready drafts, but they are not final validated investor/user-facing proof because manual competitor inspection and prototype/user validation remain open.',
