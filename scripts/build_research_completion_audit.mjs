...
const requirements = [
  {
    ...
    proof: `master_plan=${fs.existsSync('docs/research-expansion-master-plan.md')}; roadmap_rows=${roadmap.length}; execution_dashboard_rows=${validationExecutionDashboard.length}; hypothesis_decision_rows=${hypothesisDecisions.length}; p0_command_rows=${p0CommandCenter.length}; p0_field_guide_sections=${p0FieldGuide.length}; validation_workspace_lanes=${validationWorkspace.length}; validation_batch01_rows=${validationBatch01.length}; validation_batch02_rows=${validationBatch02.length}`,
    evidence_files: 'docs/research-expansion-master-plan.md;data_processed/validation_gap_roadmap.csv;data_processed/validation_execution_dashboard.csv;data_processed/hypothesis_decision_matrix.csv;data_processed/p0_validation_command_center.csv;data_processed/p0_validation_field_guide.csv;data_processed/validation_evidence_workspace_index.csv;data_processed/validation_batch_01_index.csv;data_processed/validation_batch_02_index.csv;docs/decision/validation-gap-roadmap-v1.md;docs/decision/validation-execution-dashboard-v1.md;docs/decision/hypothesis-decision-matrix-v1.md;docs/decision/p0-validation-command-center-v1.md;docs/decision/p0-validation-field-guide-v1.md;docs/decision/validation-evidence-workspace-v1.md;docs/decision/validation-batch-01-v1.md;docs/decision/validation-batch-02-v1.md',
