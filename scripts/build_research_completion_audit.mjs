...
const requirements = [
  ...
  },
  {
    ...
    evidence_strength: 'medium',
    proof: `feature_rows=${feature.length}; primary_top100_apps=${primaryApps}; evidence_claims=${evidence.length}; prototype_segments=${prototypeSegments}; prototype_screens=${prototypeScreens}; prototype_flow_rows=${prototypeStimulusFlow.length}; russian_product_loop_cards=${russianProductLoopCards.length}; russian_prototype_session_dossiers=${russianPrototypeSessionDossiers.length}; prototype_scorecard_metrics=${prototypeScorecard.length}; prototype_capture_rows=${prototypeSessionCapture.length}`,
    evidence_files: 'data_processed/product_core_evidence_matrix.csv;data_processed/prototype_validation_stimulus_flow.csv;data_processed/russian_product_loop_cards.csv;data_processed/russian_prototype_session_dossiers.csv;data_processed/prototype_validation_scorecard.csv;data_processed/prototype_session_capture_sheet.csv;docs/product/product-core-evidence-v1.md;docs/product/prototype-validation-stimulus-v1.md;docs/product/russian-product-loop-cards-v1.md;docs/product/russian-prototype-session-dossiers-v1.md;docs/strategy/value-proposition-v1.md;data_processed/evidence_claim_register.csv;docs/decision/validation-capture-sheets-v1.md',
