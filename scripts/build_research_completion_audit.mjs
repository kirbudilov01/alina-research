...
const requirements = [
  ...
  },
  {
    ...
    proof: `report_md=${fs.existsSync('reports/alina-evidence-first-report-draft.md')}; evidence_pdf=${fs.existsSync('output/pdf/alina-evidence-first-report-draft.pdf')}; visual_pdf=${fs.existsSync('output/pdf/alina-evidence-visual-report-v1.pdf')}; polished_evidence_pack_pdf=${polishedPdfExists}; polished_evidence_pack_doc=${polishedPdfDocExists}; russian_narrative_report=${russianNarrativeReportExists}; russian_narrative_pdf=${russianNarrativePdfExists}; russian_narrative_map=${russianNarrativeMapExists}; russian_market_deep_dive_rows=${russianMarketDeepDives.length}; russian_claim_appendix_rows=${russianClaimAppendix.length}; russian_source_provenance_rows=${russianSourceProvenance.length}; russian_competitor_battlecards=${russianCompetitorBattlecards.length}; russian_icp_battlecards=${russianIcpBattlecards.length}; russian_product_loop_cards=${russianProductLoopCards.length}`,
    evidence_files: 'reports/alina-evidence-first-report-draft.md;reports/alina-russian-narrative-report-v1.md;data_processed/russian_narrative_evidence_map.csv;data_processed/russian_market_deep_dives.csv;data_processed/russian_claim_evidence_appendix.csv;data_processed/russian_source_provenance_index.csv;data_processed/russian_competitor_battlecards.csv;data_processed/russian_icp_battlecards.csv;data_processed/russian_product_loop_cards.csv;docs/decision/russian-narrative-evidence-map-v1.md;docs/market/russian-market-deep-dives-v1.md;docs/decision/russian-claim-evidence-appendix-v1.md;docs/decision/russian-source-provenance-index-v1.md;docs/competitive/russian-competitor-battlecards-v1.md;docs/audience/russian-icp-battlecards-v1.md;docs/product/russian-product-loop-cards-v1.md;output/pdf/alina-evidence-first-report-draft.pdf;output/pdf/alina-evidence-visual-report-v1.pdf;output/pdf/alina-polished-evidence-pack-v1.pdf;output/pdf/alina-russian-narrative-report-v1.pdf;docs/decision/polished-evidence-pack-v1.md',
