...
const requirements = [
  {
    ...
    evidence_files: 'docs/research-expansion-master-plan.md;data_processed/validation_gap_roadmap.csv;data_processed/validation_execution_dashboard.csv;data_processed/hypothesis_decision_matrix.csv;data_processed/p0_validation_command_center.csv;data_processed/p0_validation_field_guide.csv;data_processed/validation_evidence_workspace_index.csv;docs/decision/validation-gap-roadmap-v1.md;docs/decision/validation-execution-dashboard-v1.md;docs/decision/hypothesis-decision-matrix-v1.md;docs/decision/p0-validation-command-center-v1.md;docs/decision/p0-validation-field-guide-v1.md;docs/decision/validation-evidence-workspace-v1.md',
