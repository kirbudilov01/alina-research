...
const requirements = [
  ...
  },
  {
    ...
    evidence_strength: 'medium',
    proof: `audience_rows=${audience.length}; community_referral_rows=${communityReferralRows.length}; community_referral_signals=${communityReferralSummary.length}; reddit_signal_rows=${redditMentionSignals.length}; reddit_signal_groups=${Object.keys(countBy(redditMentionSignals, 'signal_group')).length}; reddit_medium_plus_signals=${redditMediumPlusSignals.length}; reddit_app_summary_rows=${redditMentionAppSummary.length}; icp_segments=${icpSegments.length}; icp_validation_tests=${icpValidation.length}; icp_recruiting_bridge_rows=${icpRecruitingBridge.length}; icp_recruiting_message_rows=${icpRecruitingMessages.length}; icp_capture_rows=${icpInterviewCapture.length}`,
    evidence_files: 'data_processed/audience_signal_matrix.csv;data_processed/community_referral_signal_rows.csv;data_processed/community_referral_summary.csv;data_processed/reddit_mention_signal_matrix.csv;data_processed/reddit_mention_app_summary.csv;data_processed/icp_segment_matrix.csv;data_processed/icp_validation_test_plan.csv;data_processed/icp_recruiting_bridge.csv;data_processed/icp_recruiting_message_bank.csv;data_processed/icp_interview_capture_sheet.csv;docs/audience/community-referral-evidence-v1.md;docs/audience/reddit-mention-signal-matrix-v1.md;docs/audience/icp-segment-matrix-v1.md;docs/audience/icp-validation-packet-v1.md;docs/audience/icp-recruiting-bridge-v1.md;docs/decision/validation-capture-sheets-v1.md',
