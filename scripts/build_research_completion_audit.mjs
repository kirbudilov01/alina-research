...
const requirements = [
  ...
  },
  {
    ...
    evidence_strength: 'medium',
    proof: `feature_rows=${feature.length}; primary_top100_apps=${primaryApps}; evidence_claims=${evidence.length}; prototype_segments=${prototypeSegments}; prototype_screens=${prototypeScreens}; prototype_flow_rows=${prototypeStimulusFlow.length}; russian_product_loop_cards=${russianProductLoopCards.length}; russian_prototype_session_dossiers=${russianPrototypeSessionDossiers.length}; russian_voc_objection_map=${russianVocObjectionMap.length}; russian_field_session_kit=${russianFieldSessionKit.length}; prototype_scorecard_metrics=${prototypeScorecard.length}; prototype_capture_rows=${prototypeSessionCapture.length}`,
