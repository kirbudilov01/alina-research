...
const WORKSPACE = path.join(ROOT, 'tmp', 'presentations', THREAD_ID, 'aura-trendvi-style-deck-v7');
...
const PLAN_OUT = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v7.md');
const SOURCE_NOTES = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v7-sources.md');
const PPTX_OUT = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V7.pptx');
const CONTACT_SHEET = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V7_CONTACT_SHEET.png');
...
function writePlan() {
  const lines = ['# AURA Trendvi-Style Product Deck V7', '', 'Deck mode: optimized client-facing AURA product deck. V7 separates the client story from the evidence appendix: the main flow explains product, competitor data, money logic and launch decision; appendix keeps detailed tables and calculations.', ''];
