...
const WORKSPACE = path.join(ROOT, 'tmp', 'presentations', THREAD_ID, 'aura-trendvi-style-deck-v2');
...
const PLAN_OUT = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v2.md');
const SOURCE_NOTES = path.join(ROOT, 'reports', 'aura-trendvi-style-deck-v2-sources.md');
const PPTX_OUT = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V2.pptx');
const CONTACT_SHEET = path.join(OUTPUT_DIR, 'AURA_TRENDVI_STYLE_DECK_V2_CONTACT_SHEET.png');
...
function bodyFor(slide, n) {
  ...
  ctx.addText(slide, { text: 'Продуктовая / инвесторская презентация · V2', left: 390, top: 382, width: 650, height: 34, fontSize: 24, fontFace: 'Arial', color: C.muted, align: 'center' });
`;
  }
