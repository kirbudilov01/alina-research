...
const requiredArtifacts = [
  ...
  'data_processed/russian_report_steering_brief.csv',
  ...
  'docs/competitive/niche-count-reconciliation-v1.md',
  ...
  'docs/decision/p0-validation-execution-slice-v1.md',
  'docs/decision/p0-observed-evidence-intake-v1.md',
  'docs/decision/next-p0-sprint-kit-v1.md',
  'docs/decision/global-report-readability-audit-v1.md',
  'docs/decision/russian-sequential-storyline-v1.md',
  'docs/decision/russian-frontmatter-dashboard-v1.md',
  'docs/decision/russian-reader-glossary-v1.md',
  'docs/decision/russian-decision-recommendations-v1.md',
  'docs/decision/russian-report-steering-brief-v1.md',
  'docs/decision/alina-sample-style-profile-v1.md',
