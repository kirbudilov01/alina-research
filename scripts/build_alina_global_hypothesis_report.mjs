...
lines.push('');
lines.push('### Что еще нужно усилить до версии 10/10');
lines.push('');
lines.push('Текущая версия уже ведет читателя по правильной цепочке: идея -> пять направлений -> масштаб данных -> деньги -> конкуренты -> повторяющиеся паттерны -> белое пятно -> аудитория -> продуктовая петля -> техническая реализуемость -> монетизация -> финмодель -> план проверки. Но чтобы отчет воспринимался как дорогая полноценная работа, а не как черновик большого анализа, нужно усилить несколько мест.');
lines.push('');
lines.push(mdTable([
  {
    block: 'Логика повествования',
    status: 'Сильная основа',
    check: 'Гипотезы идут последовательно, и каждая следующая часть отвечает на предыдущий риск.',
    gap: 'На первых страницах нужно еще быстрее показать финальную рекомендацию: почему именно АУРА, почему сейчас и почему начинать с этой петли.'
  },
  {
    block: 'Масштаб данных',
    status: 'Сильный слой',
    check: 'Есть счетчики по пяти нишам, большая база, источники, конкуренты, пользовательские сигналы и слой цен/платных экранов.',
    gap: 'Нужно сделать отдельную ручную выборку главных конкурентов, чтобы читатель видел не только масштаб базы, но и качество первичного опыта внутри приложений.'
  },
  {
    block: 'Конкурентные паттерны',
    status: 'Рабочий слой',
    check: 'Видны повторяющиеся функции: ежедневная петля, reset, streak/progress, avatar/identity, AI-персонализация, community, платная глубина.',
    gap: 'Нужен отдельный ручной разбор 15-25 главных конкурентов с экранами первого опыта и платного экрана, чтобы доказать, что полной петли у них нет.'
  },
  {
  ...
  },
  {
    ...
    check: 'Есть карта сервисов для текста, изображений, голоса, video/avatar, платежей, аналитики и локальных моделей.',
    gap: 'После выбора точного avatar-сценария нужна короткая таблица выбора поставщиков: качество, цена, права, скорость, риски и роль в MVP.'
  },
  {
    block: 'Монетизация и финмодель',
    status: 'Добавлена как отдельный слой',
    check: 'Есть события аналитики, логика платного экрана, статьи себестоимости, формулы и сценарии подписка/image/video/hybrid.',
    gap: 'Нужно уточнить модель после проверки реальных цен конкурентов, готовности платить, повторного возврата и стоимости привлечения.'
  },
  {
    ...
    gap: 'Нужно еще сильнее убрать сухие англицизмы, служебные формулировки и повторы, чтобы документ читался как цельная стратегия.'
  }
], [
  { key: 'block', label: 'Блок' },
...
lines.push('');
lines.push('Главный вывод этого редакторского прохода: отчет уже можно читать как полноценную исследовательскую рамку, но до версии 10/10 ему не хватает трех вещей: ручного разбора главных конкурентов, уточнения финмодели на реальных ценах и 8-12 прототипных интервью. Следующий шаг должен быть не “еще больше данных вообще”, а точечное усиление этих трех доказательных слоев.');
lines.push('');
