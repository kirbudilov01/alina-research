...
const rows = [
  ...
  },
  {
    ...
    primary_metric: `${expanded.length} dedup rows; ${expandedRaw.length} raw expanded rows; ${itchOk.length} usable itch rows; ${steamTagOk.length} usable Steam tag rows; ${desktopStoreOk.length} usable desktop store rows; ${chromeExtensionOk.length} usable Chrome Web Store rows; ${chromeExtensionDetailOk.length} Chrome detail pages`,
    ...
    evidence_files: 'data_raw/expanded/all_expanded_raw.csv;data_raw/expanded/all_expanded_dedup.csv;data_raw/expanded/p0_external_sources_raw.csv;data_raw/expanded_itch_raw.csv;data_raw/expanded_steam_tags_raw.csv;data_raw/expanded_desktop_store_raw.csv;data_raw/expanded_chrome_extensions_raw.csv;data_raw/chrome_extension_detail_raw.csv;data_processed/p0_external_source_summary.csv;data_processed/itch_source_summary.csv;data_processed/steam_tag_source_summary.csv;data_processed/desktop_store_source_summary.csv;data_processed/chrome_webstore_source_expansion_summary.csv;data_processed/chrome_extension_fit_matrix.csv;data_processed/chrome_extension_mechanic_battlecards.csv;data_processed/competitor_feature_matrix.csv;docs/competitive/expanded-source-map.md;docs/competitive/p0-external-source-collection-v1.md;docs/competitive/itch-source-expansion-v1.md;docs/competitive/steam-tag-expansion-v1.md;docs/competitive/desktop-store-expansion-v1.md;docs/competitive/chrome-webstore-source-expansion-v1.md;docs/competitive/chrome-extension-detail-enrichment-v1.md;docs/competitive/chrome-extension-mechanic-battlecards-v1.md',
    strongest_support: 'Large normalized universe exists across App Store, Steam, Google Play fallback, source-native itch.io/Steam tags, source-native Mac App Store desktop search, and Chrome Web Store expansion with detail-page enrichment and mechanic battlecards.',
  ...
  },
  {
    ...
    confidence: 'medium',
    primary_metric: `${behaviorTied.length}/100 strict behavior-tied progression signals; ${manualInspectionPacket.length} P0 apps queued; ${publicListingVisibleCausality.length} public listing visible causality case`,
    ...
    evidence_files: 'data_processed/whitespace_signal_matrix.csv;data_processed/product_core_evidence_matrix.csv;data_processed/chrome_extension_mechanic_battlecards.csv;data_processed/manual_competitor_inspection_packet.csv;data_processed/manual_competitor_inspection_rubric.csv;data_processed/public_listing_inspection_results.csv;docs/intersections/whitespace-map-v2.md;docs/product/product-core-evidence-v1.md;docs/competitive/chrome-extension-mechanic-battlecards-v1.md;docs/competitive/manual-competitor-inspection-packet-v1.md;docs/competitive/public-listing-inspection-v1.md',
    strongest_support: 'Broad adjacent market is crowded; strict behavior-tied avatar progression appears rare in metadata; the public-listing inspection confirms only a small high-risk visible-causality set and keeps the rest as walkthrough-dependent.',
    key_gap: 'Actual app/onboarding inspection results are still missing; public listings can overstate or hide in-app loops.',
