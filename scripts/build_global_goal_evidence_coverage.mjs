...
function gateRatio(id, field) {
  const gate = gates.find(row => row.hypothesis_id === id) || {};
  return gate[field] || '0 / 0';
}
...
const rows = [
  ...
  },
  {
    ...
    evidence_strength_ru: 'средне-сильное',
    current_evidence_ru: `global report md=${exists('reports/alina-global-hypothesis-report-v1.md')}; pdf=${exists('output/pdf/alina-global-hypothesis-report-v1.pdf')}; docx=${exists('output/docx/alina-global-hypothesis-report-v1.docx')}; executive_md=${exists('reports/alina-global-executive-narrative-v1.md')}; executive_pdf=${exists('output/pdf/alina-global-executive-narrative-v1.pdf')}; reader_md=${exists('reports/alina-global-reader-report-v1.md')}; reader_pdf=${exists('output/pdf/alina-global-reader-report-v1.pdf')}; glossary_rows=${countRows('data_processed/russian_reader_glossary.csv')}; readability_audit_rows=${countRows('data_processed/global_report_readability_audit.csv')}; storyline_rows=${countRows('data_processed/russian_sequential_storyline.csv')}; dashboard_rows=${countRows('data_processed/russian_frontmatter_dashboard.csv')}`,
    key_files: 'reports/alina-global-hypothesis-report-v1.md;reports/alina-global-executive-narrative-v1.md;reports/alina-global-reader-report-v1.md;output/pdf/alina-global-hypothesis-report-v1.pdf;output/pdf/alina-global-executive-narrative-v1.pdf;output/pdf/alina-global-reader-report-v1.pdf;output/docx/alina-global-hypothesis-report-v1.docx;data_processed/russian_reader_glossary.csv;docs/decision/russian-reader-glossary-v1.md;data_processed/global_report_readability_audit.csv;docs/decision/global-report-readability-audit-v1.md;data_processed/russian_sequential_storyline.csv;docs/decision/russian-sequential-storyline-v1.md;data_processed/russian_frontmatter_dashboard.csv;docs/decision/russian-frontmatter-dashboard-v1.md',
  ...
  },
  {
    ...
    current_evidence_ru: `gates=${gates.length}; hold_validate=${gateOpen}; started=${gateStarted}; p0_intake_rows=${countRows('data_processed/p0_observed_evidence_intake.csv')}; H1_completed=${gateRatio('H1', 'completed_vs_required')}; H1_success=${gateRatio('H1', 'success_vs_threshold')}; H3_completed=${gateRatio('H3', 'completed_vs_required')}; H3_success=${gateRatio('H3', 'success_vs_threshold')}; H2_completed=${h2Completed}; H2_success=${h2Success}; H5_completed=${gateRatio('H5', 'completed_vs_required')}; H5_success=${gateRatio('H5', 'success_vs_threshold')}; H4_completed=${gateRatio('H4', 'completed_vs_required')}; H4_success=${gateRatio('H4', 'success_vs_threshold')}; H6_completed=${gateRatio('H6', 'completed_vs_required')}; H6_success=${gateRatio('H6', 'success_vs_threshold')}`,
    key_files: 'data_processed/global_hypothesis_gate_snapshot.csv;data_processed/global_next_validation_backlog.csv;data_processed/validation_gate_calculator.csv;data_processed/p0_observed_evidence_intake.csv;docs/decision/p0-observed-evidence-intake-v1.md;data_processed/manual_walkthrough_capture_sheet.csv;data_processed/icp_interview_capture_sheet.csv;data_processed/prototype_session_capture_sheet.csv',
