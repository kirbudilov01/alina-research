# Validation Batch 02 Note: P0_SCORE_PVS_M06

- command_id: P0_SCORE_PVS_M06
...
Market-money evidence needs product-level willingness-to-pay validation.
...
- pass_gate: >=40% name a plausible paid depth feature after free loop value is clear
- downgrade_or_kill_gate: Users expect all value free or reject paid depth after seeing loop
