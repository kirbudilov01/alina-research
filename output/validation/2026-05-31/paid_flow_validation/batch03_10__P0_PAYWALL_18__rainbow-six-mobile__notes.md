# Validation Batch 03 Note: P0_PAYWALL_18

- command_id: P0_PAYWALL_18
- lane: paid_flow_validation
- priority: P1_context
- target: Rainbow Six Mobile
- linked_hypotheses: H2
- date: 2026-05-31
- operator:
- source_url: https://ubisoft-mobile.helpshift.com/hc/en/45-rainbow-six-mobile/
...
weak_or_unconfirmed_public_signal; confidence=low; price=none
...
- screenshot_paths: output/paywall_screenshots/18-rainbow-six-mobile-medium.png
- notes_paths:
- participant_quote_or_visible_text:
- observed_value: weak_or_unconfirmed_public_signal; confidence=low; price=none
