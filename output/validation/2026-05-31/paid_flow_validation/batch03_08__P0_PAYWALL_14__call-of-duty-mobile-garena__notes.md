# Validation Batch 03 Note: P0_PAYWALL_14

- command_id: P0_PAYWALL_14
- lane: paid_flow_validation
- priority: P1_context
- target: Call of Duty®: Mobile - Garena
- linked_hypotheses: H2
- date: 2026-05-31
- operator:
- source_url: https://codm.garena.tw/
...
weak_or_unconfirmed_public_signal; confidence=low; price=$5,00
...
- screenshot_paths: output/paywall_screenshots/14-call-of-duty-mobile-garena-medium.png
- notes_paths:
- participant_quote_or_visible_text:
- observed_value: weak_or_unconfirmed_public_signal; confidence=low; price=$5,00
