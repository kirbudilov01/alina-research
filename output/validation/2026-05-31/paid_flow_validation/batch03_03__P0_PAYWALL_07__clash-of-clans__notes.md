# Validation Batch 03 Note: P0_PAYWALL_07

- command_id: P0_PAYWALL_07
- lane: paid_flow_validation
- priority: P1_context
- target: Clash of Clans
- linked_hypotheses: H2
- date: 2026-05-31
- operator:
- source_url: https://support.supercell.com/en/index.html
...
- screenshot_paths: output/paywall_screenshots/07-clash-of-clans-medium.png
- notes_paths:
