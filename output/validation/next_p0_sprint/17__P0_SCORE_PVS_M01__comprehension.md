# P0_SCORE_PVS_M01: comprehension
...
- comprehension: success >=80% of prototype participants correctly explain personal meaning -> action -> avatar/progress causality; kill <50% can explain the causal loop without prompting
...
Pass signal: >=80% of prototype participants correctly explain personal meaning -> action -> avatar/progress causality

Downgrade signal: <50% can explain the causal loop without prompting
